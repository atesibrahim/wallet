...
VALUES ('1', 'Alice', 'Smith', '12345678901', 'a@ates.com', '$2a$10$ibkpUkiG/pQq5aWt13M5VOUbABiSFt5C6/74TV6d9eSzslmrq3M7y', 'ADMIN', 'admin', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP),
       ('2', 'Bob', 'Johnson', '23456789012', 'b@ates.com', '$2a$10$4HGSug4UK9vCw5Fwbg6kae6mhCmGILcTZ2vfuOJLc9Y1JYWXRLCz2', 'CUSTOMER', 'admin', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP),
       ('3', 'Bob', 'Johnson', '23456789012',  'c@ates.com', '$2a$10$0LDDYZXnES0Xjm0k0RWinORMcAd5FXgzvZpq8Le4A1L9.9nn8CyeW', 'USER', 'admin', CURRENT_TIMESTAMP, 'admin', CURRENT_TIMESTAMP);
